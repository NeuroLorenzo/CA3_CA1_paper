...
save_w=0
###########################################
#trials=(30 40 50 60 70 80 90 100)
trials=(80 90 100)
...
do 
	...
	do
		...
		cd /base_folder
		python scripts/Sonata_pipeline.py $sonata_folder $trial $train_test $gid_stim_file $shuff 
		python scripts/save_output_simulation.py ${sonata_folder} $placement_file $trial $train_test $gid_stim_file $shuff
		"
	done
done
