...
sonata_folder='network_sl7_400' #"network_4000_400" #"network_sl7_400" 
...
gid_stim_file='gid_stim_400_sl7.csv' #gid_stim_400_4000.csv #gid_stim_400_sl7.csv
shuff=0
save_w=0
##########################################
